...
'</div>',
'',
'<div class="checkbox col-sm-offset-2" ng-show="$parent.$first == false">',
'',
'  <div class="app-mergetype" ng-if="ctrl.datasource.basedOnDs >= 0">',
'    <label><input type="radio" ng-model="ctrl.datasource.basedType" checked value="plusminusrange"><span translate="">plusminusrange</span> </label>',
'  </div>',
'</div>',
'',
'',
...
'          <div class="modal-body">',
'            <div class="list-group">',
'              <a href="" ng-repeat="indicator in ctrl.allIndicators" class="list-group-item" ng-if="ctrl.indicators.indexOf(indicator) < 0"',
