...
'    <gd-myboard class="app-dashboard"></gd-myboard>',
'  </div>',
'',
...
'          <a href="admin" data-target="#global" aria-controls="global" role="tab" data-toggle="tab" translate="" title="{{\'globalT\'|translate}}">global</a>',
'        </li>',
'        <li role="presentation">',
'          <a href="admin" data-target="#datasource" aria-controls="datasource" role="tab" data-toggle="tab" translate="" title="{{\'datasourceT\'|translate}}">datasource</a>',
'        </li>',
'        <li role="presentation">',
'          <a href="admin" data-target="#graph" aria-controls="graph" role="tab" data-toggle="tab" translate="" title="{{\'graphT\'|translate}}">graph</a>',
'        </li>',
'',
...
'<div class="checkbox col-sm-offset-2" ng-if="!(ctrl.datasource.basedOnDs >= 0)" ng-show="$parent.$first == false">',
'  <label>',
